...
<section class="page-header aboutus">
  <div class="container">
            ...
            <div class="col-lg-6 col-md-12">
                ...
                <div class="about-content">
                    <div class="about-text-block">
                        ...
                        <p>Whether you want to learn you’ve come to the right place. As a global destination for online learning, we connect people through knowledge.</p>
                    </div>

                     <div class="about-text-block">
                        <i class="bi bi-film"></i>
                        <h4>Achieve your goals
</h4>
                        <p>Follow a recommended learning plan, specifically designed to help you build your knowledge and accomplish your career goals.
</p>
                    </div>

                    <a href="courses.php" class="btn btn-main-2"><i class="fa fa-check mr-2"></i>more About Support</a>
                </div>
            </div>
            <div class="col-lg-6 col-md-12">
                <div class="about-img">
