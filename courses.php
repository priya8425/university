    ...
    <section class="course-grid-2">
        <div class="container">
            ...
            <li class="active"><a href="#" data-filter="*"> All</a></li>
                    <li><a href="webdevelopment.php" data-filter=".cat1">Web & App Development</a></li>
                    <li><a href="#" data-filter=".cat2">Digital Marketing</a></li>
                    <li><a href="#" data-filter=".cat3">Graphic Designing</a></li>
                    <li><a href="#" data-filter=".cat4">Application Designing</a></li>
                    <li><a href="#" data-filter=".cat5">Website Development</a></li>
                ...
                <div class="course-item cat2 col-lg-4 col-md-6">
                    <div class="course-block style-5">
                        <div class="course-img">
                            <img src="admin/dist/img/background/<?php echo $arr['upload_icon'];?>"style="height: 250px; width: 500px; ">
                        </div>
                        ...
                        <div class="course-content">
                            ...
                            <div class="course-meta">
                                ...
                                <span class="course-duration"><i class="bi bi-badge3"></i>6 <?php echo $arr['lessons'];?></span>
                            </div> 
                        </div>
                    </div>
                </div>
