...
<div class="form-group">
  ...
  <input type="text" class="form-control" value="'.$arr['title'].'" name="course_name" id="" placeholder="">
</div>
<div class="custom-file">
  <input type="file" name="upload_icon" value="'.$arr['icon'].'" class="custom-file-input" id="formFileMultiple">
