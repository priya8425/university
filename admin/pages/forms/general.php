...
<div class="wrapper">
  ...
  <div class="content-wrapper">
                  ...
                  <div class="form-group col">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="background_image" id="exampleInputFile">
    ...
    ?>
                    ...
                    <td><img src="../../dist/img/background/<?php echo $arr['upload_icon'];?>" style="height:150px; width:150px;"></td>
                    <td><?php echo $arr['duration'];?></td>
                    
                    <td><?php echo $arr['price'];?></td>
                    
                      <td> <a href="general.php?id=<?php echo $row['did']; ?>"><button type="button" class="btn btn-primary btn-md" style="color: aliceblue"> <i class="fas fa-pen"></i></button></a>
                      
                      <a href="general.php?delsr_no=<?php echo $arr['sr_no']; ?>"><button type="button" class="btn btn-danger btn-md" style="color: aliceblue"> <i class="fas fa-trash"></i></button></a>
                    </tr>
                    <?php $count++; }  ?>
                  </tbody>
                </table>
